...
public class FeedbackUploadTask extends AsyncTask<FeedbackModel, String, String> {
	...
	protected void onPostExecute(String result) {
		...
		Toast.makeText(mActivity, "Your feedback has been uploaded", Toast.LENGTH_LONG).show();;
	...
	protected String doInBackground(FeedbackModel... params) {
		...
		String targetURL = "http://pharmakit.co/android_api/feedback/feedback.php";
